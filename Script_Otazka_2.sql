...
JOIN (
	...
	FROM t_daniel_rizak_project_sql_primary_final
	WHERE unit != 'czk' AND `year` IN (2006, 2018) AND category_code = '114201') fin2
	ON fin1.`year` = fin2.`year`
